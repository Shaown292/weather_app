...
class AppTextStyle {
  ...
  static const  TextStyle circularW300size122 = TextStyle(color: Colors.white, fontSize:100 , fontFamily: "Circular Std");
  static const  TextStyle circularW400size18 = TextStyle(color: Colors.white, fontSize:18 , fontFamily: "Circular Std");
  static const  TextStyle circularW400size15 = TextStyle(color: Colors.white, fontSize:15 , fontFamily: "Circular Std");
